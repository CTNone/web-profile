...
- Development rules: `.github/instructions/ck-development.instructions.md`
- Frontend rules: `.github/instructions/ck-frontend.instructions.md`
- Backend rules: `.github/instructions/ck-backend.instructions.md`
- Testing rules: `.github/instructions/ck-testing.instructions.md`
